! function (e, n, r) {
    "use strict";
    n.module("FileManagerApp", ["pascalprecht.translate", "ngFileUpload"]), r(e.document).on("shown.bs.modal", ".modal", function () {
        e.setTimeout(function () {
            r("[autofocus]", this).focus()
        }.bind(this), 100)
    }), r(e.document).on("click", function () {
        r("#context-menu").hide()
    }), r(e.document).on("contextmenu", '.main-navigation .table-files tr.item-list:has("td"), .item-list', function (n) {
        ...
        for (var n, r = Object(this), i = r.length >>> 0, a = arguments[1], t = 0; t < i; t++)
            if (n = r[t], e.call(a, n, t, r)) return n
    })
}(window, angular, jQuery),
function (e, n) {
    "use strict";
    e.module("FileManagerApp").controller("FileManagerCtrl", ["$scope", "$rootScope", "$window", "$translate", "fileManagerConfig", "item", "fileNavigator", "apiMiddleware", function (e, r, i, a, t, o, s, l) {
        var d = i.localStorage;
        e.config = t, e.reverse = !1, e.predicate = ["model.type", "model.name"], e.order = function (n) {
            ...
            var i = e.temps.indexOf(n),
                a = r && 3 == r.which;
            if (r && r.target.hasAttribute("prevent")) return void (e.temps = []);
            if (!(!n || a && e.isSelected(n))) {
                ...
                return r && !a && (r.ctrlKey || r.metaKey) ? void (e.isSelected(n) ? e.temps.splice(i, 1) : e.temps.push(n)) : void (e.temps = [n])
            }
            ...
            if (n.isFolder()) return e.fileNavigator.folderClick(n);
            if ("function" == typeof e.config.pickCallback && r) {
                var i = e.config.pickCallback(n.model);
                if (i === !0) return
            }
            return n.isImage() ? e.config.previewImagesInModal ? e.openImagePreview(n) : e.apiMiddleware.download(n, !0) : n.isEditable() ? e.openEditItem(n) : void 0
        }, e.openImagePreview = function () {
            var n = e.singleSelection();
            e.apiMiddleware.apiHandler.inprocess = !0, e.modal("imagepreview", null, !0).find("#imagepreview-target").attr("src", e.apiMiddleware.getUrl(n)).unbind("load error").on("load error", function () {
            ...
            var t = n("#" + r);
            return t.modal(i ? "hide" : "show"), e.apiMiddleware.apiHandler.error = "", e.apiMiddleware.apiHandler.asyncSuccess = !1, !a || t
        }, e.modalWithPathSelector = function (n) {
            return r.selectedModalPath = e.fileNavigator.currentPath, e.modal(n)
            ...
            var n = e.singleSelection();
            if (!e.selectionHas("dir")) return n ? e.apiMiddleware.download(n) : e.apiMiddleware.downloadMultiple(e.temps)
        }, e.copy = function () {
            var n = e.singleSelection();
            if (n) {
                var i = n.tempModel.name.trim(),
                    t = e.fileNavigator.fileNameExists(i);
                if (t && c(n)) return e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"), !1;
                if (!i) return e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"), !1
            }
            e.apiMiddleware.copy(e.temps, r.selectedModalPath).then(function () {
                e.fileNavigator.refresh(), e.modal("copy", !0)
            })
        }, e.compress = function () {
            var n = e.temp.tempModel.name.trim(),
                i = e.fileNavigator.fileNameExists(n);
            return i && c(e.temp) ? (e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"), !1) : n ? void e.apiMiddleware.compress(e.temps, n, r.selectedModalPath).then(function () {
            ...
            var n = e.temp,
                ...
                t = e.fileNavigator.fileNameExists(i);
            return t && c(e.temp) ? (e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"), !1) : i ? void e.apiMiddleware.extract(n, i, r.selectedModalPath).then(function () {
            ...
            return n && c(n) ? (e.apiMiddleware.apiHandler.error = a.instant("error_cannot_move_same_path"), !1) : void e.apiMiddleware.move(e.temps, r.selectedModalPath).then(function () {
                e.fileNavigator.refresh(), e.modal("move", !0)
            })
        }, e.rename = function () {
            var n = e.singleSelection(),
                r = n.tempModel.name,
                i = n.tempModel.path.join("") === n.model.path.join("");
            return !r || i && e.fileNavigator.fileNameExists(r) ? (e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"), !1) : void e.apiMiddleware.rename(n).then(function () {
                e.fileNavigator.refresh(), e.modal("rename", !0)
            })
        }, e.createFolder = function () {
            var n = e.singleSelection(),
                r = n.tempModel.name;
            return !r || e.fileNavigator.fileNameExists(r) ? e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename") : void e.apiMiddleware.createFolder(n).then(function () {
                e.fileNavigator.refresh(), e.modal("newfolder", !0)
            })
        }, e.addForUpload = function (n) {
            e.uploadFileList = e.uploadFileList.concat(n), e.modal("uploadfile")
            ...
            e.apiMiddleware.upload(e.uploadFileList, e.fileNavigator.currentPath).then(function () {
                ...
                var r = n.result && n.result.error || a.instant("error_uploading_files");
                e.apiMiddleware.apiHandler.error = r
            })
        };
        var c = function (e) {
            var n = r.selectedModalPath.join(""),
                i = e && e.model.path.join("");
            return i === n
        },
            p = function (e) {
                var n = i.location.search.substr(1).split("&").filter(function (n) {
                    return e === n.split("=")[0]
                });
...
function (e) {
    "use strict";
    e.module("FileManagerApp").controller("ModalFileManagerCtrl", ["$scope", "$rootScope", "fileNavigator", function (e, n, r) {
        e.reverse = !1, e.predicate = ["model.type", "model.name"], e.fileNavigator = new r, n.selectedModalPath = [], e.order = function (n) {
            e.reverse = e.predicate[1] === n && !e.reverse, e.predicate[1] = n
        }, e.select = function (r) {
            n.selectedModalPath = r.model.fullPath().split("/"), e.modal("selector", !0)
        }, e.selectCurrent = function () {
            n.selectedModalPath = e.fileNavigator.currentPath, e.modal("selector", !0)
            ...
            e.fileNavigator.currentPath = n, e.fileNavigator.refresh(), e.modal("selector")
        }, n.getSelectedPath = function () {
            var r = n.selectedModalPath.filter(Boolean),
                i = "/" + r.join("/");
    ...
    e.module("FileManagerApp").service("chmod", function () {
        var e = function (e) {
            if (this.owner = this.getRwxObj(), this.group = this.getRwxObj(), this.others = this.getRwxObj(), e) {
                ...
                if (!n) throw new Error("Invalid chmod input data (%s)".replace("%s", e));
        ...
        return e.prototype.toOctal = function (e, n) {
            ...
            return ["owner", "group", "others"].forEach(function (e, n) {
                r[n] = this[e].read && this.octalValues.read || 0, r[n] += this[e].write && this.octalValues.write || 0, r[n] += this[e].exec && this.octalValues.exec || 0
            }.bind(this)), (e || "") + r.join("") + (n || "")
        }, e.prototype.toCode = function (e, n) {
            var r = [];
            return ["owner", "group", "others"].forEach(function (e, n) {
                r[n] = this[e].read && this.codeValues.read || "-", r[n] += this[e].write && this.codeValues.write || "-", r[n] += this[e].exec && this.codeValues.exec || "-"
            }.bind(this)), (e || "") + r.join("") + (n || "")
            ...
            if (e = ("" + e).replace(/\s/g, ""), e = 10 === e.length ? e.substr(1) : e, /^[-rwxts]{9}$/.test(e)) {
                ...
                for (var i in r) {
                    ...
                    a.read = /r/.test(r[i]), a.write = /w/.test(r[i]), a.exec = /x|t/.test(r[i]), n.push(a)
                }
                return {
                    owner: n[0],
                    group: n[1],
            ...
            if (e = ("" + e).replace(/\s/g, ""), e = 4 === e.length ? e.substr(1) : e, /^[0-7]{3}$/.test(e)) {
                ...
                for (var i in r) {
                    var a = this.getRwxObj();
                    a.read = /[4567]/.test(r[i]), a.write = /[2367]/.test(r[i]), a.exec = /[1357]/.test(r[i]), n.push(a)
                }
                return {
                    owner: n[0],
                    group: n[1],
...
function (e) {
    "use strict";
    e.module("FileManagerApp").factory("item", ["fileManagerConfig", "chmod", function (n, r) {
        var i = function (n, i) {
            function a(e) {
        ...
        return i.prototype.update = function () {
            ...
            return !this.isFolder() && n.isEditableFilePattern.test(this.model.name)
            ...
            return !this.isFolder() && n.isExtractableFilePattern.test(this.model.name)
        }, i.prototype.isSelectable = function () {
            return this.isFolder() && n.allowedActions.pickFolders || !this.isFolder() && n.allowedActions.pickFiles
        }, i
    }])
}(angular),
function (e) {
    ...
    n.filter("strLimit", ["$filter", function (e) {
        return function (n, r, i) {
            return n.length <= r ? n : e("limitTo")(n, r) + (i || "...")
        }
    }]), n.filter("fileExtension", ["$filter", function (e) {
        return function (n) {
            return /\./.test(n) && e("strLimit")(n.split(".").pop(), 3, "..") || ""
        }
    ...
    }]), n.filter("humanReadableFileSize", ["$filter", "fileManagerConfig", function (e, n) {
...
function (e, n) {
    "use strict";
    e.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "Upload", function (e, r, i, a, t) {
        e.defaults.headers.common["X-Requested-With"] = "XMLHttpRequest";
        var o = function () {
            this.inprocess = !1, this.asyncSuccess = !1, this.error = ""
        };
        return o.prototype.deferredHandler = function (e, n, r, i) {
            return e && "object" == typeof e || (this.error = "Error %s - Bridge response error, please check the API docs or this ajax response.".replace("%s", r)), 404 == r && (this.error = "Error 404 - Backend bridge is not working, please check the ajax response."), e.result && e.result.error && (this.error = e.result.error), !this.error && e.error && (this.error = e.error.message), !this.error && i && (this.error = i), this.error ? n.reject(e) : n.resolve(e)
            ...
            return t.inprocess = !0, t.error = "", e.post(n, l).success(function (e, n) {
                o(e, s, n)
            }).error(function (e, n) {
                o(e, s, n, "Unknown error listing, check the response")
            })["finally"](function () {
                t.inprocess = !1
            }), s.promise
            ...
            return o && 1 === i.length && (d.singleFilename = o), s.inprocess = !0, s.error = "", e.post(n, d).success(function (e, n) {
                s.deferredHandler(e, l, n)
            }).error(function (e, n) {
                s.deferredHandler(e, l, n, a.instant("error_copying"))
            })["finally"](function () {
                s.inprocess = !1
            }), l.promise
            ...
            return o.inprocess = !0, o.error = "", e.post(n, l).success(function (e, n) {
                o.deferredHandler(e, s, n)
            }).error(function (e, n) {
                o.deferredHandler(e, s, n, a.instant("error_moving"))
            })["finally"](function () {
                o.inprocess = !1
            }), s.promise
            ...
            return t.inprocess = !0, t.error = "", e.post(n, s).success(function (e, n) {
                t.deferredHandler(e, o, n)
            }).error(function (e, n) {
                t.deferredHandler(e, o, n, a.instant("error_deleting"))
            })["finally"](function () {
                t.inprocess = !1
            }), o.promise
            ...
            return t.inprocess = !0, t.error = "", e.post(n, s).success(function (e, n) {
                ...
                t.deferredHandler(e, o, n, a.instant("error_getting_content"))
            })["finally"](function () {
                t.inprocess = !1
            }), o.promise
            ...
            return o.inprocess = !0, o.error = "", e.post(n, l).success(function (e, n) {
                ...
                o.deferredHandler(e, s, n, a.instant("error_modifying"))
            })["finally"](function () {
                o.inprocess = !1
            }), s.promise
            ...
            return o.inprocess = !0, o.error = "", e.post(n, l).success(function (e, n) {
                ...
                o.deferredHandler(e, s, n, a.instant("error_renaming"))
            })["finally"](function () {
                o.inprocess = !1
            }), s.promise
            ...
            return d.inprocess = !0, e.get(c).success(function (e) {
                ...
                d.deferredHandler(e, p, n, a.instant("error_downloading"))
            })["finally"](function () {
                d.inprocess = !1
            }), p.promise
            ...
            return l && !d && i.saveAs ? (c.inprocess = !0, e.get(t).success(function (e) {
                ...
                c.deferredHandler(e, p, n, a.instant("error_downloading"))
            })["finally"](function () {
                c.inprocess = !1
            ...
            return s.inprocess = !0, s.error = "", e.post(n, d).success(function (e, n) {
                s.deferredHandler(e, l, n)
            }).error(function (e, n) {
                s.deferredHandler(e, l, n, a.instant("error_compressing"))
            })["finally"](function () {
                s.inprocess = !1
            }), l.promise
            ...
            return s.inprocess = !0, s.error = "", e.post(n, d).success(function (e, n) {
                ...
                s.deferredHandler(e, l, n, a.instant("error_extracting"))
            })["finally"](function () {
                s.inprocess = !1
            }), l.promise
        }, o.prototype.changePermissions = function (n, i, t, o, s) {
            var l = this,
                d = r.defer(),
                c = {
            ...
            return l.inprocess = !0, l.error = "", e.post(n, c).success(function (e, n) {
                l.deferredHandler(e, d, n)
            }).error(function (e, n) {
                l.deferredHandler(e, d, n, a.instant("error_changing_perms"))
            })["finally"](function () {
                l.inprocess = !1
            }), d.promise
            ...
            return t.inprocess = !0, t.error = "", e.post(n, s).success(function (e, n) {
                ...
                t.deferredHandler(e, o, n, a.instant("error_creating_folder"))
            })["finally"](function () {
                t.inprocess = !1
            }), o.promise
        }, o
...
function (e) {
    "use strict";
    e.module("FileManagerApp").service("apiMiddleware", ["$window", "fileManagerConfig", "apiHandler", function (e, n, r) {
        var i = function () {
        ...
        return i.prototype.getPath = function (e) {
            ...
            return this.apiHandler.copy(n.copyUrl, i, this.getPath(r), a)
            ...
            var r = this.getFilePath(e);
            return this.apiHandler.edit(n.editUrl, r, e.tempModel.content)
            ...
            var i = this.getFilePath(e),
                a = e.model.name;
            if (!e.isFolder()) return this.apiHandler.download(n.downloadFileUrl, i, a, n.downloadFilesByAjax, r)
        }, i.prototype.downloadMultiple = function (e, r) {
            var i = this.getFileList(e),
                a = (new Date).getTime().toString().substr(8, 13),
                t = a + "-" + n.multipleDownloadFileName;
            return this.apiHandler.downloadMultiple(n.downloadMultipleUrl, i, t, n.downloadFilesByAjax, r)
        }, i.prototype.compress = function (e, r, i) {
            var a = this.getFileList(e);
            return this.apiHandler.compress(n.compressUrl, a, r, this.getPath(i))
        }, i.prototype.extract = function (e, r, i) {
            var a = this.getFilePath(e);
            return this.apiHandler.extract(n.extractUrl, a, r, this.getPath(i))
        }, i.prototype.changePermissions = function (e, r) {
            var i = this.getFileList(e),
                a = r.tempModel.perms.toCode(),
                t = r.tempModel.perms.toOctal(),
                o = !!r.tempModel.recursive;
            return this.apiHandler.changePermissions(n.permissionsUrl, i, a, t, o)
...
function (e) {
    "use strict";
    e.module("FileManagerApp").service("fileNavigator", ["apiMiddleware", "fileManagerConfig", "item", function (e, n, r) {
        var i = function () {
        ...
        return i.prototype.deferredHandler = function (e, n, r, i) {
            return e && "object" == typeof e || (this.error = "Error %s - Bridge response error, please check the API docs or this ajax response.".replace("%s", r)), 404 == r && (this.error = "Error 404 - Backend bridge is not working, please check the ajax response."), !this.error && e.result && e.result.error && (this.error = e.result.error), !this.error && e.error && (this.error = e.error.message), !this.error && i && (this.error = i), this.error ? n.reject(e) : n.resolve(e)
            ...
            return e.requesting = !0, e.fileList = [], e.list().then(function (n) {
            ...
            function i(e, n, r) {
                ...
                if (e.name.trim() && 0 !== r.trim().indexOf(e.name) && (e.nodes = []), e.name !== r) e.nodes.forEach(function (e) {
                    i(e, n, r)
                });
                else {
                ...
                e.nodes = e.nodes.sort(function (e, n) {
                    return e.name.toLowerCase() < n.name.toLowerCase() ? -1 : e.name.toLowerCase() === n.name.toLowerCase() ? 0 : 1
                })
            }

            function a(e, n) {
                n.push(e);
                for (var r in e.nodes) a(e.nodes[r], n)
            }
            ...
            !this.history.length && this.history.push({
                ...
                nodes: []
            }), a(this.history[0], o), s = t(o, e), s && (s.nodes = []);
            for (var l in this.fileList) {
                var d = this.fileList[l];
                d instanceof r && d.isFolder() && i(this.history[0], d, e)
            }
            ...
            return this.fileList.find(function (n) {
                return e.trim && n.model.name.trim() === e.trim()
            })
