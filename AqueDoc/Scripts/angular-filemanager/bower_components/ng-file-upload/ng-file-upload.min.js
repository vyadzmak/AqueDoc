/*! 12.0.1 */ !window.XMLHttpRequest || window.FileAPI && FileAPI.shouldLoad || (window.XMLHttpRequest.prototype.setRequestHeader = function (a) {
    return function (b, c) {
        if ("__setXHR_" === b) {
            var d = c(this);
...
ngFileUpload.version = "12.0.1", ngFileUpload.service("UploadBase", ["$http", "$q", "$timeout", function (a, b, c) {
    function d(d) {
        function e(a) {
    ...
    function f(a, b, c) {
        var e = [h.emptyPromise()];
        return angular.forEach(a, function (d, f) {
            0 === d.type.indexOf("image/jpeg") && h.attrGetter("ngfFixOrientation", b, c, {
                $file: d
            }) && e.push(h.happyPromise(h.applyExifRotation(d), d).then(function (b) {
                a.splice(f, 1, b)
            }))
        }), d.all(e)
    }
    ...
    function g(a, b, c) {
        function e(d, e) {
            if (0 === d.type.indexOf("image")) {
                if (f.pattern && !h.validatePattern(d, f.pattern)) return;
                var i = h.resize(d, f.width, f.height, f.quality, f.type, f.ratio, f.centerCrop, function (a, e) {
                    return h.attrGetter("ngfResizeIf", b, c, {
                        $width: a,
                        $height: e,
                        $file: d
                    })
                }, f.restoreExif !== !1);
                g.push(i), i.then(function (b) {
                    a.splice(e, 1, b)
                }, function (a) {
        ...
        var f = h.attrGetter("ngfResize", b, c);
        if (!(f && angular.isObject(f) && h.isResizeSupported() && a.length)) return h.emptyPromise();
        for (var g = [h.emptyPromise()], i = 0; i < a.length; i++) e(a[i], i);
        return d.all(g)
    }
    var h = e;
    return h.getAttrWithDefaults = function (a, b) {
        if (null != a[b]) return a[b];
        var c = h.defaults[b];
        return null == c ? c : angular.isString(c) ? c : JSON.stringify(c)
    }, h.attrGetter = function (b, c, d, e) {
    ...
    }, h.shouldUpdateOn = function (a, b, c) {
        var d = h.attrGetter("ngModelOptions", b, c);
        return d && d.updateOn ? d.updateOn.split(" ").indexOf(a) > -1 : !0
    }, h.emptyPromise = function () {
        var a = d.defer(),
            c = arguments;
        return b(function () {
            a.resolve.apply(a, c)
        }), a.promise
    }, h.rejectPromise = function () {
        var a = d.defer(),
            c = arguments;
        return b(function () {
            a.reject.apply(a, c)
        }), a.promise
    }, h.happyPromise = function (a, c) {
        var e = d.defer();
        ...
        function m(f, g, j, l, m) {
            ...
            var p = h.attrGetter("ngfModelInvalid", d);
            p && b(function () {
                a(p).assign(e, m ? o : g)
            }), b(function () { })
        }
        ...
        function q() {
            ...
            g(z ? r : w, d, e).then(function () {
                z ? h.validate(r, A, c, d, e).then(function () {
                    p(), a()
                }) : a()
            }, function (a) {
        ...
        var x = h.attrGetter("ngfKeep", d, e);
        r = (j || []).slice(0), ("distinct" === x || h.attrGetter("ngfKeepDistinct", d, e) === !0) && n(d, e);
        var y = !x && !h.attrGetter("ngfMultiple", d, e) && !h.attrGetter("multiple", d);
        if (!x || r.length) {
            h.attrGetter("ngfBeforeModelChange", d, e, {
                $files: j,
            ...
            var z = h.attrGetter("ngfValidateAfterResize", d, e),
                A = r.length + s.length + t.length,
                B = h.attrGetter("ngModelOptions", d, e);
            h.validate(r, A, c, d, e).then(function () {
                l ? m(r, [], j, u, y) : (B && B.allowInvalid || z ? w = r : p(), h.attrGetter("ngfFixOrientation", d, e) && h.isExifSupported() ? f(w, d, e).then(function () {
                    q()
                }) : q())
            })
        }
    ...
    function () {
        ...
        return f.validatePattern = function (a, b) {
            ...
            a && a.$formatters.push(function (d) {
                a.$dirty && (d && !angular.isArray(d) && (d = [d]), f.validate(d, d ? d.length : 0, a, b, c).then(function () {
                ...
                if (a) {
                    for (var i = a.length, j = null; i--;) {
                        ...
                        if (k) {
                            ...
                            null != l && (h(k, l) || (k.$error = b, (k.$errorMessages = k.$errorMessages || {}).name = !0, k.$errorParam = l, a.splice(i, 1), j = !1))
                        }
                    }
            ...
            function i(c, h, i, k, l) {
                function m(a, b, d) {
                    null != d ? k(b, d).then(function (e) {
                        l(e, d) ? a.resolve() : (b.$error = c, (b.$errorMessages = b.$errorMessages || {}).name = !0, b.$errorParam = d, a.reject())
                    }, function () {
                        j("ngfValidateForce", {
                            $file: b
                        }) ? (b.$error = c, (b.$errorMessages = b.$errorMessages || {}).name = !0, b.$errorParam = d, a.reject()) : a.resolve()
                    }) : a.resolve()
                }
            ...
            a = void 0 === a.length ? [a] : a.slice(0), h("maxFiles", null, function (a, b) {
                return b >= c
            ...
            return c(function () {
                return 0 !== a.type.indexOf("image") ? void e.reject("not image") : void f.dataUrl(a).then(function (b) {
                    ...
                    var h = angular.element("<img>").attr("src", b).css("visibility", "hidden").css("position", "fixed");
        ...
        return c.dataUrltoBlob = function (a, b, c) {
            ...
            return c.dataUrl(a, !0).then(function (b) {
                e(b, d, f, g, h || a.type, i, j, k).then(function (d) {
                    ...
                    m.resolve(c.dataUrltoBlob(d, a.name, a.size))
                }, function (b) {
                    "resizeIf" === b && m.resolve(a), m.reject()
                })
            }, function () {
                m.reject()
            }), m.promise
